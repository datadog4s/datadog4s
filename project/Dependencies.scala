...
object Dependencies {
  object Cats {
    val effect = "org.typelevel" %% "cats-effect" % "3.5.3"
    val core   = "org.typelevel" %% "cats-core"   % "2.10.0"
  }

  object Datadog {
    val statsDClient = "com.datadoghq" % "java-dogstatsd-client" % "4.3.0"
  }

  object Http4s {
    val core = "org.http4s" %% "http4s-core" % "0.23.25"
  }
  ...
  object Mdoc {
    val libMdoc = "org.scalameta" %% "mdoc" % "2.5.2" excludeAll (
