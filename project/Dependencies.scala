...
object Dependencies {
  ...
  object Http4s {
    val core212 = "org.http4s" %% "http4s-core" % "0.21.8"
    val core213 = "org.http4s" %% "http4s-core" % "0.21.8"
  }

  object Testing {
    val mockitoScalatest = "org.mockito"   %% "mockito-scala-scalatest" % "1.15.1"
    val munit            = "org.scalameta" %% "munit"                   % "0.7.16"
  }
  ...
  object Mdoc {
    val libMdoc = "org.scalameta" %% "mdoc" % "2.2.11" excludeAll (ExclusionRule(
